...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product_category_create')): ?>
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="<?php echo e(route('admin.product-categories.create')); ?>">
                <?php echo e(trans('global.add')); ?> <?php echo e(trans('cruds.productCategory.title_singular')); ?>
...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('cruds.productCategory.title_singular')); ?> <?php echo e(trans('global.list')); ?>
            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-ProductCategory">
                ...
                <tbody>
                    <?php $__currentLoopData = $productCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $productCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-entry-id="<?php echo e($productCategory->id); ?>">
                            <td>
                            ...
                            <td>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product_category_show')): ?>
                                    <a class="btn btn-xs btn-primary" href="<?php echo e(route('admin.product-categories.show', $productCategory->id)); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product_category_edit')): ?>
                                    <a class="btn btn-xs btn-info" href="<?php echo e(route('admin.product-categories.edit', $productCategory->id)); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product_category_delete')): ?>
                                    <form action="<?php echo e(route('admin.product-categories.destroy', $productCategory->id)); ?>" method="POST" onsubmit="return confirm('<?php echo e(trans('global.areYouSure')); ?>');" style="display: inline-block;">
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product_category_delete')): ?>
  ...
  let deleteButton = {
    ...
    url: "<?php echo e(route('admin.product-categories.massDestroy')); ?>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\grafissia\resources\views/admin/productCategories/index.blade.php ENDPATH**/ ?>